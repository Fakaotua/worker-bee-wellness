      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600 text-sm">All therapists are background checked, licensed, and insured for your protection.</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600 text-sm">All payments are processed securely through Square&apos;s encrypted platform.</p>
          </div>
